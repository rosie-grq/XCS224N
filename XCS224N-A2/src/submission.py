...
def naive_softmax_loss_and_gradient(center_word_vec,outside_word_idx,outside_vectors,dataset=None):
  ...
  ### START CODE HERE
  #print('outside shape',outside_vectors.shape)
  #print('center shape',center_word_vec.shape)
  ...
  #print('grad_center',grad_center_vec.shape)
  #print('grad outside',grad_outside_vecs.shape)
  ### END CODE HERE
...
def skipgram(current_center_word, window_size, outside_words, word2ind, center_word_vectors, outside_vectors, dataset, word2vec_loss_and_gradient=neg_sampling_loss_and_gradient):
  ...
  for word in outside_words:
     ...
     if word2vec_loss_and_gradient==neg_sampling_loss_and_gradient:
        loss_current, gradc, grado = neg_sampling_loss_and_gradient(center_word_vec, outside_word_idx, outside_vectors, dataset,K=10)
     else:
